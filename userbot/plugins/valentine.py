...
from userbot import bot as KANNADIGABOT
...
@bot.on(admin_cmd(pattern="vday$"))
@bot.on(sudo_cmd(pattern="vday$", allow_sudo=True))
async def gif(event):
    if event.fwd_from:
        return
    ...
    if x == 1:
        await event.edit(
            f"My love for you \nSets my heart on fire \nand makes each day of my life \nSo special \n\n [✍️](https://telegra.ph/file/688abc98761f031128b9b.jpg) {KANNADIGA}",
            link_preview=True,
        )
    if x == 2:
        await event.edit(
            f"What I Need to live \nhas been given to me \nby the earth. Why I need \nto live has been given to\nme by you \n\n [✍️](https://telegra.ph/file/b6ab919f97283fc0d8c39.jpg) {KANNADIGA}",
            link_preview=True,
        )
    if x == 3:
        await event.edit(
