...
async def _(event):
    if event.fwd_from:
        return
    KANNADIGA = bot.uid
    USERNAME = f"tg://user?id={KANNADIGA}"
    ...
    KANNADIGAevent = await event.reply(f"{name} is ejected.......🤐")
    await asyncio.sleep(2)
    await KANNADIGAevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await KANNADIGAevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    KANNADIGAevent = await edit_or_reply(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await KANNADIGAevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
