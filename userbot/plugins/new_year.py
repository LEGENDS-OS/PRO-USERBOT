...
# Happy New Year plugin by Mr_Professor_Agora for KANNADIGABOT
# Kangers keep credits...
# Now in KANNADIGABOT

# credits to KANNADIGA, john snow
# credits to KANNADIGA, john snow
import asyncio
import random
